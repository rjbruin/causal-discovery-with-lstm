...
def testEffectMatcher():
    ...
    dataset = GeneratedExpressionDataset('./data/seq2ndmarkov_both_fixed/all.txt', './data/seq2ndmarkov_both_fixed/test.txt', './data/seq2ndmarkov_both_fixed/config.json',
                                         operators=2,
                                         digits=8,
