...
def set_up_statistics(output_dim, n_max_digits, symbols):
    return {'correct': 0.0, 'valid': 0.0, 'inDataset': 0.0,
            ...
            'prediction_1_size': 0,
            'digit_1_correct': {k: 0. for k in range(n_max_digits+1)}, 
            'digit_1_score': {k: 0. for k in range(n_max_digits+1)},
            'digit_1_prediction_size': {k: 0 for k in range(n_max_digits+1)},
            'prediction_1_histogram': {k: 0 for k in range(output_dim)},
            'prediction_2_size': 0, 
            'digit_2_correct': {k: 0. for k in range(n_max_digits+1)}, 
            'digit_2_score': {k: 0. for k in range(n_max_digits+1)},
            'digit_2_prediction_size': {k: 0 for k in range(n_max_digits+1)},
            ...
            'samplesCorrect': [],
            'prediction_sizes': {k: 0 for k in range(n_max_digits+1)},
            'prediction_size_correct': {k: 0. for k in range(n_max_digits+1)},
            'label_sizes': {k: 0 for k in range(n_max_digits+1)},
            'label_size_correct': {k: 0. for k in range(n_max_digits+1)},
            'input_sizes': {k: 0 for k in range(n_max_digits+1)},
            'recovery': {k: 0 for k in range(9)},
            'no_recovery': {k: 0 for k in range(9)},
            ...
            'left_missing_vs_left_size_correct': np.zeros((n_max_digits+1,n_max_digits+1), dtype='int16'),
            'left_missing_vs_left_size_size': np.zeros((n_max_digits+1,n_max_digits+1), dtype='int16'),
            ...
            'x_offset_size': {k: 0 for k in range(n_max_digits+1)},
            'x_offset_correct': {k: 0 for k in range(n_max_digits+1)},
