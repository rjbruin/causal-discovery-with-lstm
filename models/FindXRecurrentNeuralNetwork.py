...
class FindXRecurrentNeuralNetwork(RecurrentModel):
    '''
    ...
    def __init__(self, data_dim, hidden_dim, output_dim, minibatch_size, 
        ...
        encode_parameters = [self.vars[k[0]] for k in filter(lambda varset: varset[0][-1] != 'Y', varSettings)];
        ...
        super(FindXRecurrentNeuralNetwork, self).__init__();
